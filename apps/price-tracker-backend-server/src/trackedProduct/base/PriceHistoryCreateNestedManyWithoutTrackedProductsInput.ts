...
@InputType()
class PriceHistoryCreateNestedManyWithoutTrackedProductsInput {
...
export { PriceHistoryCreateNestedManyWithoutTrackedProductsInput as PriceHistoryCreateNestedManyWithoutTrackedProductsInput };
