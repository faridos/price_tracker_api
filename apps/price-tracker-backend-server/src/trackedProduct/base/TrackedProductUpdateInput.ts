...
@InputType()
class TrackedProductUpdateInput {
  @ApiProperty({
    required: false,
    type: Number,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => PriceHistoryUpdateManyWithoutTrackedProductsInput,
  })
  @ValidateNested()
  @Type(() => PriceHistoryUpdateManyWithoutTrackedProductsInput)
  @IsOptional()
  @Field(() => PriceHistoryUpdateManyWithoutTrackedProductsInput, {
    nullable: true,
  })
...
export { TrackedProductUpdateInput as TrackedProductUpdateInput };
